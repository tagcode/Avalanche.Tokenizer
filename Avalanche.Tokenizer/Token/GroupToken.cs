...
public struct GroupToken : IToken
{
    ...
    public bool Accept(ITokenVisitor visitor) { if (visitor is ITokenVisitor<GroupToken> c) { c.Visit(this); return true; } else return false; }
