...
public struct BooleanExpressionToken : IToken
{
    /// <summary>Create token</summary>
    public BooleanExpressionToken() { }
    ...
    public bool Accept(ITokenVisitor visitor) { if (visitor is ITokenVisitor<BooleanExpressionToken> c) { c.Visit(this); return true; } else return false; }
