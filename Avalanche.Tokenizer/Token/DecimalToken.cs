...
/// <summary>Token that spans over decimal number.</summary>
public struct DecimalToken : IToken
{
    ...
    public bool Accept(ITokenVisitor visitor) { if (visitor is ITokenVisitor<DecimalToken> c) { c.Visit(this); return true; } else return false; }
