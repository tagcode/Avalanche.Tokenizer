...
/// <summary>Token that spans parenthesis '(' and ')'</summary>
public struct ParenthesisToken : IToken
{
    ...
    public bool Accept(ITokenVisitor visitor) { if (visitor is ITokenVisitor<ParenthesisToken> c) { c.Visit(this); return true; } else return false; }
