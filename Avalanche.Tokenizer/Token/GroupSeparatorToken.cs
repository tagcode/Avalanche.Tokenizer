...
public struct GroupSeparatorToken : IToken
{
    /// <summary>Create token</summary>
    public GroupSeparatorToken() { }
    ...
    public bool Accept(ITokenVisitor visitor) { if (visitor is ITokenVisitor<GroupSeparatorToken> c) { c.Visit(this); return true; } else return false; }
