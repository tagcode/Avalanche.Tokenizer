...
public struct KeyToken : IToken
{
    ...
    public bool Accept(ITokenVisitor visitor) { if (visitor is ITokenVisitor<KeyToken> c) { c.Visit(this); return true; } else return false; }
