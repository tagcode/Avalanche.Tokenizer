...
/// <summary>Token that spans over <see cref="KeyToken"/>, <see cref="ValueToken"/> and possibly <see cref="WhitespaceToken"/>, <see cref="OperandToken"/> and <see cref="SeparatorToken"/></summary>
public struct KeyValueToken : IToken
{
    ...
    public bool Accept(ITokenVisitor visitor) { if (visitor is ITokenVisitor<KeyValueToken> c) { c.Visit(this); return true; } else return false; }
